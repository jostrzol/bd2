...
Każda ankieta jest zawsze automatycznie tworzona oraz usuwana razem z pełnym zestawem odpowiedzi (nawet na pytania opcjonalne ale z oceną nieokreśloną).';
...
Odpowiedzi są zawsze automatycznie tworzone i usuwane razem z ankietą, dlatego nigdy nie należy ich ręcznie tworzyć lub usuwać. Należy jedynie zmieniać ocenę odpowiedzi.';
...
COMMENT ON COLUMN osoby.pesel IS
    'Składa się dokładnie z 11 cyfr.';

COMMENT ON COLUMN osoby.nr_karty_stalego_klienta IS
    'Składa dokładnie z 13 cyfr, aby łatwo można było go zareprezentować w postaci kodu kreskowego EAN-13.';
...
Pytań nie należy dodawać ani usuwać w sytuacjach, gdy typ ankiety, do którego przynależą, jest już wykorzystywany w jakichkolwiek ankietach.';
